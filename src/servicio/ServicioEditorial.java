...
public class ServicioEditorial {
    ...
    /**
     * METODO CREA LA EDITORIAL Y LA GUARDA EN LA BBDD
     */
    ...
    /**
     * METODO DEVUELVE UNA LISTA DE EDITORIALES DESDE LA BBDD
     */
...
/**
 * METODO EDITA UNA EDITORIAL SEGUN LO QUE ESPECIFIQUE EL USUARIO
 */
        ...
        try {
            ...
            switch (op) {
                ...
                case 2:
                    ...
                    if (opcion == 1) {
                        editorialDao.editorialAlta(e);
                    }
                    if (opcion == 2) {
                        editorialDao.editorialBaja(e);
                    }
                    break;
                default:
            ...
            System.out.println("Error al escoger una opcion" + ex);
        }
